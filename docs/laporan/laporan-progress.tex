...
\bibitem{elmasri2015}
  ...
  \textit{Fundamentals of Database Systems}. 7th edn.
  Boston: Pearson Education.

\bibitem{mysql2024}
  Oracle Corporation (2024)
  \textit{MySQL 8.0 Reference Manual}.
  Available at: \url{https://dev.mysql.com/doc/refman/8.0/en/} (Accessed: 18 May 2026).

\bibitem{expressjs2024}
  OpenJS Foundation (2024)
  \textit{Express.js Documentation}.
  Available at: \url{https://expressjs.com/} (Accessed: 18 May 2026).

\bibitem{nextjs2024}
  Vercel (2024)
  \textit{Next.js Documentation}.
  Available at: \url{https://nextjs.org/docs} (Accessed: 18 May 2026).

\bibitem{zod2024}
  Colinhacks (2024)
  \textit{Zod: TypeScript-first schema validation}.
  Available at: \url{https://zod.dev/} (Accessed: 18 May 2026).
\end{thebibliography}
